...
We first implemented a CIS statistics course in the 2015&ndash;2016 academic year. Since that time, we have had 17 high schools teach a CIS statistics course. The map below shows these schools.
...
Students who recehe curriculum from 
...
Students use the TinkerPlots&trade; software during class and as a part of their at-home preparation and homework. TinkerPlots&trade; employs allows students to create models and simulate date using an interactive set of tools. The visual display of the simulation process helps students gain a deeper conceptual understanding of the underlying data generation process used in statistical inference.
